...
class DeepLearningModelName(enum.Enum):
    ...
    DETERMINISTIC_ACTOR_CRITIC_MLP = "DETERMINISTIC_ACTOR_CRITIC_MLP"
    DETERMINISTIC_ACTOR_CRITIC_GRU = "DETERMINISTIC_ACTOR_CRITIC_GRU"
    DETERMINISTIC_ACTOR_CRITIC_GRU_ATTENTION = "DETERMINISTIC_ACTOR_CRITIC_GRU_ATTENTION"

    OLD_ACTOR_CRITIC_MLP = "OLD_ACTOR_CRITIC_MLP"
    OLD_ACTOR_CRITIC_CNN = "OLD_ACTOR_CRITIC_CNN"
...
class RLAlgorithmName(enum.Enum):
    ...
    CONTINUOUS_A2C_FAST_V0 = "CONTINUOUS_A2C_FAST_V0"   # FAST_RL
