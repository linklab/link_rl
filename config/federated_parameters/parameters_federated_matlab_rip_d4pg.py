...
class PARAMETERS_FEDERATED_MATLAB_RIP_D4PG(PARAMETERS_GENERAL):
    ...
    DEEP_LEARNING_MODEL = DeepLearningModelName.D4PG_ACTOR_CRITIC_MLP
    ...
    ACTION_SCALE = SWING_UP_SCALE_FACTOR = 0.05
    BALANCING_SCALE_FACTOR = 0.015
    ...
    STATE_INCLUSION_MOTOR_VELOCITY = True
