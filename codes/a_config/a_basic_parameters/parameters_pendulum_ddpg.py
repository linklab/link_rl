...
class PARAMETERS_PENDULUM_DDPG(PARAMETERS_GENERAL, PARAMETERS_DDPG):
    ...
    # DEEP_LEARNING_MODEL = DeepLearningModelName.DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN
    # DEEP_LEARNING_MODEL = DeepLearningModelName.DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN_ATTENTION
    ...
    TYPE_OF_DDPG_ACTION = DDPGActionType.ONLY_OU_NOISE
