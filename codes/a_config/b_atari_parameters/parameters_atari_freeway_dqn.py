...
class PARAMETERS_FREEWAY_DQN(PARAMETERS_GENERAL, PARAMETERS_DQN):
    ENVIRONMENT_ID = EnvironmentName.FREEWAY_NO_FRAME_SKIP_V4
    RL_ALGORITHM = RLAlgorithmName.DQN_V0
    DEEP_LEARNING_MODEL = DeepLearningModelName.DUELING_DQN_CNN

    TRAIN_STOP_EPISODE_REWARD = 24.0
    TRAIN_STOP_EPISODE_REWARD_STD = 1.0
