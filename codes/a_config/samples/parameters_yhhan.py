...
# class PARAMETERS(PARAMETERS_RL_PENDULUM_DDPG):
#     PER = False

# class PARAMETERS(PARAMETERS_RL_PENDULUM_D4PG):
#     PER = False

# class PARAMETERS(PARAMETERS_RL_PENDULUM_PPO):
#     PER = False

# class PARAMETERS(PARAMETERS_RL_PENDULUM_MATLAB_DDPG):
#     ENV_RESET = False

# class PARAMETERS(PARAMETERS_RL_CARTPOLE_DQN):
#     pass