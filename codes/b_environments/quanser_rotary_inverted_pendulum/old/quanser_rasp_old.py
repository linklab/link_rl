...
MQTT_SUB_FROM_ENV_POWER = 'motor_power_3'
MQTT_SUB_RESET = 'reset_3'
MQTT_PUB_RESET_COMPLETE = 'reset_complete_3'
MQTT_PUB_TO_ENV = 'servo_info_3'
MQTT_PUB_MOTOR_LIMIT = 'motor_limit_info_3'
MQTT_PUB_TO_EDGEX = 'monitoring_info_3'
MQTT_ERROR = 'error_3'
...
class QubeServo2:
    def __init__(self):
        ...
        self.pub = mqtt.Client(client_id="servo_pub_3", transport="TCP")
        self.pub.username_pw_set(username="link", password="0123")
        self.pub.connect(MQTT_SERVER, 1883, 3600)

        self.sub = mqtt.Client(client_id="servo_sub_3", transport="TCP")
        ...
        self.sub.connect(MQTT_SERVER, 1883, 3600)
    ...
    try:
        ...
        while True:
            try:
                ...
                pub = mqtt.Client(client_id="servo_pub_2", transport="TCP")
                pub.username_pw_set(username="link", password="0123")
                pub.connect(MQTT_SERVER, 1883, 3600)
