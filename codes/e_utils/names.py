...
class DeepLearningModelName(enum.Enum):
    ...
    STOCHASTIC_DISCRETE_ACTOR_CRITIC_RNN = "STOCHASTIC_DISCRETE_ACTOR_CRITIC_RNN"
    STOCHASTIC_CONTINUOUS_ACTOR_CRITIC_RNN = "STOCHASTIC_CONTINUOUS_ACTOR_CRITIC_RNN"
    ...
    DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN = "DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN"
    DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN_ATTENTION = "DETERMINISTIC_CONTINUOUS_ACTOR_CRITIC_RNN_ATTENTION"
