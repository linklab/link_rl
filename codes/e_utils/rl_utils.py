...
def get_single_environment(params=None, mode=AgentMode.TRAIN):
    if params.ENVIRONMENT_ID == EnvironmentName.REAL_DEVICE_RIP:
        ...
        from codes.b_environments.quanser_rotary_inverted_pendulum.adjust_angle import ADJUSTAngleEnv
        env = ADJUSTAngleEnv(mode=mode)
        ...
        EnvironmentName.PYBULLET_INVERTED_DOUBLE_PENDULUM_V0, EnvironmentName.PYBULLET_HUMANOID_V0
    ]:
