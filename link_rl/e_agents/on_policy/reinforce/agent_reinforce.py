...
from link_rl.c_models.c_actor_models import DiscreteActorModel, ContinuousStochasticActorModel
from link_rl.e_agents.on_policy.on_policy_agent import OnPolicyAgent


class AgentReinforce(OnPolicyAgent):
    def __init__(self, observation_space, action_space, config, need_train):
        super(AgentReinforce, self).__init__(observation_space, action_space, config, need_train)
