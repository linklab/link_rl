...
class ParameterComparisonBase:
    def __init__(self):
        ...
        # )
        #
        # TRAIN_INTERVAL_TOTAL_TIME_STEPS = self.AGENT_PARAMETERS[0].TRAIN_INTERVAL_TOTAL_TIME_STEPS
        # assert all(
        #     parameter.TRAIN_INTERVAL_TOTAL_TIME_STEPS == TRAIN_INTERVAL_TOTAL_TIME_STEPS for parameter in self.AGENT_PARAMETERS
        # )
        #
        ...
        # )
        #
        # CONSOLE_LOG_INTERVAL_TOTAL_TIME_STEPS = self.AGENT_PARAMETERS[0].CONSOLE_LOG_INTERVAL_TOTAL_TIME_STEPS
        # assert all(
        #     parameter.CONSOLE_LOG_INTERVAL_TOTAL_TIME_STEPS == CONSOLE_LOG_INTERVAL_TOTAL_TIME_STEPS for parameter in self.AGENT_PARAMETERS
        # )
        #
