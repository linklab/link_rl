...
class TwinQCritic(nn.Module):
    """
    TD3의 Twin Q-Critic: 두 개의 독립적인 Q 네트워크를 사용하여
    Q값의 과대평가(overestimation) 바이어스를 줄임
    """
    ...
    def __init__(self, n_features: int = 3, n_actions: int = 1):
        ...
        # Q1 네트워크
        self.q1_fc1 = nn.Linear(n_features, 128)
        self.q1_fc2 = nn.Linear(128 + n_actions, 128)
        self.q1_fc3 = nn.Linear(128, 1)

        # Q2 네트워크
        self.q2_fc1 = nn.Linear(n_features, 128)
        self.q2_fc2 = nn.Linear(128 + n_actions, 128)
