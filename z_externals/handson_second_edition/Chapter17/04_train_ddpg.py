...
def rl_test_net(net, env, count=10, device="cpu"):
    rewards = 0.0
    steps = 0
...
if __name__ == "__main__":
    ...
    env = gym.make(ENV_ID)
    print("Observation space:", env.observation_space, env.observation_space.high, env.observation_space.low)
    print("Action space:", env.action_space, env.action_space.high, env.action_space.low)
        ...
        with ptan.common.utils.TBMeanTracker(
            ...
            while True:
                ...
                if frame_idx % TEST_ITERS == 0:
                    ts = time.time()
                    rewards, steps = rl_test_net(act_net, test_env, device=device)
