...
if __name__ == "__main__":
    ...
    proj_hist = lib.dqn_extra.distribution_projection(
        source_distribution=src_hist,
        rewards=np.array([2], dtype=np.float32),
        dones=np.array([False]),
        Vmin=Vmin, Vmax=Vmax, N_ATOMS=N_ATOMS, gamma=0.9
    )
    ...
    src_hist = hist[0]
    proj_hist = lib.dqn_extra.distribution_projection(
        source_distribution=np.array([src_hist]),
        rewards=np.array([2], dtype=np.float32),
        dones=np.array([False]),
        Vmin=Vmin, Vmax=Vmax, N_ATOMS=N_ATOMS, gamma=0.9
    )
    ...
    proj_dist = lib.dqn_extra.distribution_projection(
        source_distribution=np.array([src_hist]),
        rewards=np.array([10], dtype=np.float32),
        dones=np.array([False]),
        Vmin=Vmin, Vmax=Vmax, N_ATOMS=N_ATOMS, gamma=0.9
    )
    ...
    proj_hist = lib.dqn_extra.distribution_projection(
        source_distribution=np.array([src_hist, src_hist]),
        rewards=np.array([2, 2], dtype=np.float32),
    ...
    proj_hist = lib.dqn_extra.distribution_projection(
        source_distribution=np.array([src_hist, src_hist]),
        rewards=np.array([10, 10], dtype=np.float32),
        dones=np.array([False, True]),
        Vmin=Vmin, Vmax=Vmax, N_ATOMS=N_ATOMS, gamma=0.9
    )
